...
function Banner({ title, desc }) {
  return (
    <div className='w-full bg-gradient-to-r from-light-green to-thick-green px-5 py-8 sm:px-4 sm:py-7 md:px-6 md:py-9 lg:px-10 lg:py-13 xl:px-14 xl:py-20 lg:mt-16 xl:mt-16'>
      <div className="mx-5 sm:mx-1 md:mx-5 lg:mx-10 xl:mx-16">
        <div className="flex flex-col gap-5 text-white">
          ...
          <div className="flex gap-5">
              ...
              <div className="flex flex-col gap-1">
                  <h2 className='font-main text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold'>{title}</h2>
                  <p className='font-secondary text-xs  sm:text-[8px] md:text-xs lg:text-sm xl:text-base font-light text-justify'>{desc}</p>
              </div>
          </div>
        </div>
      </div>
